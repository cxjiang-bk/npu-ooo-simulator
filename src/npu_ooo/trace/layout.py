...
_STAGE_BY_FILENAME: dict[str, str] = {
    ...
    "workload.json": "00_frontend",
    "input_signature.json": "00_frontend",
    "resolved_workload_config.json": "00_frontend",
...
def _root_readme() -> str:
    ...
    rows.extend(
        [
            ...
            "通用 JSON 入口还会在 `00_frontend/workload.json`、`input_signature.json` 和",
            "`resolved_workload_config.json` 保存实际模型构造、静态输入树及 CLI 覆盖后的配置。",
